...
contract AliumPair is IAliumPair, AliumERC20 {
    ...
    function swap(
        ...
        require(amount0In > 0 || amount1In > 0, "Alium: INSUFFICIENT_INPUT_AMOUNT");
        {
            ...
            uint256 balance0Adjusted = balance0.mul(10000).sub(amount0In.mul(25)); // 0,25 % to LP
            uint256 balance1Adjusted = balance1.mul(10000).sub(amount1In.mul(25)); // 0,25 % to LP
            require(
